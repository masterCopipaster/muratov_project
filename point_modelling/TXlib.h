...
$   const char image32 [32*32+1] =
        ...
        "0F0000000000000090000000000900F0"
        "0F0000000990000090990000000900F0"
        "0F0000009999000099009000000900F0"
        "0F0000039999000099009999990900F0"
        "0F0000009999000099990009009900F0"
        "0F0000000990379999009999990900F0"
        "0F000000009BB70099009000000900F0"
        "0F0000000B90000090990000000900F0"
...
void txDrawMan (int x, int y, int sizeX, int sizeY, COLORREF color, double handL, double handR, double twist,
                double head, double eyes, double wink, double crazy, double smile, double hair, double wind)
    {
$1  const char msg[] = "\0/Мне нужна твоя одежда и мотоцикл!\0/Тебе этого не объясняли на уроке!\0/Молодец, не пишешь велосипеды!\0/";
...
$   txLine (x, y - (0.8 + head - 0.05 * smile/2) * sizeY, x - 0.05 * sizeY, y - (0.8 + head + 0.05 * smile/2) * sizeY),
    txLine (x, y - (0.8 + head - 0.05 * smile/2) * sizeY, x + 0.05 * sizeY, y - (0.8 + head + 0.05 * smile/2) * sizeY),
    txNotifyIcon (4, "Все норм!", "Не ссы, ты молодец!");
